...
class NodeB<T extends Comparable<T>> {
    ...
    void setFilho(int i, NodeB<T> f) {
        this.filhos[i] = f;
    }

    void preencherRaiz(Object value, NodeB<T> r, NodeB<T> filhoDir) {
        this.infos[0] = value;
        this.filhos[0] = r;
    ...
    void insereChave(T value, NodeB<T> filhoDir) {
